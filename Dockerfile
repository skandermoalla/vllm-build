...
# docker build --build-arg max_jobs=12 --build-arg nvcc_threads=4 --build-arg buildkite_commit=$(git rev-parse --short HEAD) --progress plain --target vllm-base --tag vllm:v0.6.0-$(git rev-parse --short HEAD)-amd64-cuda-a100-h100 .
